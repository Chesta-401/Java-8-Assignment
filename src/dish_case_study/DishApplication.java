...
public class DishApplication {
	...
	public static void main(String[] args) {
		...
		//4. Count dishes in each group
		System.out.println("Counting dishes in each group");
		...
		System.out.println("Most calorie dishes by Type");
		...
		//6. Sum calories by type
		System.out.println("Sum of calories by type:");
